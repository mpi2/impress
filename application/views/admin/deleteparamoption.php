 ...
 * @param int $item_id Id of the option which we want to delete
 * @param string $errors
 * @param string $flash
 * @param bool $isLatestVersion
 */

$option = new ParamOption($item_id);
?>
...
?>    
<p><i>Warning: This option does not belong to the latest version of the parameter. Are you sure you are deleting the correct option?</i></p>
<?php
}
?>

<p>You are about to delete the parameter Option <?php echo '"(' . $option->getId() . ') ' . e($option->getName()) . '"'; ?>.</p>

<p>Deleting an option leads to the creation of a new version of this Parameter. Are you sure you want to do this?</p>

<p>If you are sure you want to delete this option and create a new version of the Parameter (and potentially the Procedure) then please complete the form below and click delete.</p>
...
<input type="hidden" name="param_option_id" value="<?php echo $option->getId(); ?>">
