...
<!--<tr>
	...
	<td><input type="text" name="centre_id" value="<?php //echo set_value('centre_id', (isset($centre_id)) ? $centre_id : ''); ?>"></td>
</tr>-->

<tr>
	<td><label for="title" class="required">Title</label></td>
	<td><input type="text" name="title" title="<?php tooltip('protocol_section_title') ?>" value="<?php echo set_value('title', (isset($title)) ? $title : ''); ?>"></td>
</tr>
<!--<tr>
